/**
 * Interview Control Tray Component
 */
...
function ControlTray({
  ...
  useEffect(() => {
    if (supportsVideo && !activeVideoStream) {
        ...
        <div className={cn("connection-container", { connected })}>
          <div className="connection-button-container">
            <button
              ...
              title={connected ? "Pause interview" : "Start interview"}
            >
          ...
          <span className="text-indicator">{connected ? "Interview in progress" : "Start Interview"}</span>
        </div>
      </div>
    </section>
  );
